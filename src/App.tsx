...
const App: React.FC = () => {
    ...
    const handleExportPDF = () => {
        ...
        autoTable(doc, {
            ...
            alternateRowStyles: { fillColor: [245, 253, 250] } // Light emerald tint
        });
                            ...
                            {activeTab === 'overview' && (
                                ...
                                >
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center gap-3">
                                                <div className="flex items-center gap-2 px-3 py-1 bg-emerald-500/10 rounded-full">
                                                    ...
                                                    <span className="text-[10px] font-black text-emerald-600 uppercase tracking-widest">Sistema Live</span>
                                                </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                        ...
                                        <div className="saas-card bg-emerald-50 border-emerald-100 text-emerald-900 shadow-xl transform transition-all hover:-translate-y-1">
                                            <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-emerald-600/60 mb-4">Liberados</p>
                                            <div className="flex items-end justify-between">
                                                <h3 className="text-5xl font-black text-emerald-600">{stats.liberated}</h3>
                                        ...
                                        <div className="saas-card bg-red-50 border-red-100 text-red-900 shadow-xl transform transition-all hover:-translate-y-1">
                                            <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-red-600/60 mb-4">Pendentes</p>
                                            <div className="flex items-end justify-between">
                                                <h3 className="text-5xl font-black text-red-500">{stats.pending}</h3>
                                        ...
                                        <div className="saas-card bg-indigo-50 border-indigo-100 text-indigo-900 shadow-xl transform transition-all hover:-translate-y-1">
                                            <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-indigo-600/60 mb-4">Eficiência</p>
                                            <div className="flex items-end justify-between">
                                                <h3 className="text-5xl font-black text-indigo-600">{stats.percentLiberated}%</h3>
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 h-[450px]">
                                        ...
                                        <div className="saas-card flex flex-col items-center justify-center relative overflow-hidden group">
                                            ...
                                            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none pt-12">
                                                <span className="text-4xl font-black text-emerald-600 leading-none">{stats.percentLiberated}%</span>
                                        ...
                                        <div className="flex flex-wrap gap-3">
                                            <div className="flex bg-white rounded-xl shadow-sm border border-saas-border p-1">
                                                <button
                                                    ...
                                                    className="px-4 py-2 hover:bg-emerald-50 text-emerald-600 rounded-lg text-xs font-black transition-all flex items-center gap-2 border border-transparent hover:border-emerald-100"
                                                >
                                                    <Download size={14} />
                                                    EXCEL
                                                </button>
                                        ...
                                        <table className="w-full text-left">
                                            <thead>
                                                <tr className="bg-slate-900 border-b border-white/10">
                                                    <th className="py-5 px-8 text-[10px] font-black text-white/40 uppercase tracking-[0.2em]">Colaborador / ID</th>
                                                    <th className="py-5 px-4 text-[10px] font-black text-white/40 uppercase tracking-[0.2em]">Função</th>
                                                    <th className="py-5 px-4 text-[10px] font-black text-white/40 uppercase tracking-[0.2em]">Admissão</th>
                                                    <th className="py-5 px-4 text-[10px] font-black text-white/40 uppercase tracking-[0.2em]">Liberação</th>
                                                    <th className="py-5 px-4 text-[10px] font-black text-white/40 uppercase tracking-[0.2em]">Dias</th>
                                                    <th className="py-5 px-4 text-[10px] font-black text-white/40 uppercase tracking-[0.2em]">Checklist</th>
                                                    <th className="py-5 px-4 text-[10px] font-black text-white/40 uppercase tracking-[0.2em]">Status</th>
                                                    <th className="py-5 px-8 text-[10px] font-black text-white/40 uppercase tracking-[0.2em] text-right">Ações</th>
                                                </tr>
                                            </thead>
                                                        ...
                                                        <td className="py-6 px-4">
                                                            <div className="flex gap-1.5">
                                                                {['rh', 'saude', 'seguranca', 'grd'].map(step => (
                                                                    <div key={step} className={`w-7 h-7 rounded-lg flex items-center justify-center border transition-all ${c[step as keyof typeof c] === 'OK' ? 'bg-brand-primary/10 border-brand-primary/20 text-brand-primary' : 'bg-slate-50 border-slate-100 text-slate-300'}`}>
                                                                        {c[step as keyof typeof c] === 'OK' ? <CheckCircle2 size={14} /> : <div className="w-1 h-1 rounded-full bg-current" />}
                                                                    </div>
                                                                ))}
                                                            </div>
                                                        </td>
                                            ...
                                            <div className="flex-1 overflow-y-auto space-y-3 pr-1 custom-scrollbar pb-10">
                                                {groupedColumns.liberado.map(c => (
                                                    <motion.div
                                                        layoutId={c.chapa}
                                                        key={c.chapa}
                                                        className="saas-card p-4 border-brand-primary/20 bg-brand-primary/[0.03] hover:border-brand-primary/40 transition-all cursor-pointer group"
                                                        onClick={() => setSelectedCollab(c)}
                                                    >
                                                        ...
                                                        <div className="flex justify-between items-end">
                                                            <span className="text-[9px] font-mono text-slate-300 tracking-widest">{c.chapa}</span>
                                                            <div className="flex gap-1">
                                                                {['rh', 'saude', 'seguranca', 'grd'].map(step => (
                                                                    <div key={step} className="w-4 h-4 rounded-full bg-brand-primary flex items-center justify-center text-white">
                                                                        <CheckCircle2 size={8} />
                                                                    </div>
                                                                ))}
                                                            </div>
                                            ...
                                            <div className="flex-1 overflow-y-auto space-y-3 pr-1 custom-scrollbar pb-10">
                                                {groupedColumns.pendente.map(c => (
                                                    <motion.div
                                                        layoutId={c.chapa}
                                                        key={c.chapa}
                                                        className="saas-card p-4 hover:border-brand-primary/20 transition-all cursor-pointer group"
                                                        onClick={() => setSelectedCollab(c)}
                                                    >
                                                        ...
                                                        <div className="flex justify-between items-end">
                                                            ...
                                                            <div className="flex gap-1">
                                                                {['rh', 'saude', 'seguranca', 'grd'].map(step => (
                                                                    <div key={step} className={`w-4 h-4 rounded-full flex items-center justify-center text-[6px] font-black ${c[step as keyof typeof c] === 'OK' ? 'bg-brand-secondary text-white' : 'bg-slate-50 text-slate-300'}`}>
                                                                        {c[step as keyof typeof c] === 'OK' ? <CheckCircle2 size={8} /> : step[0].toUpperCase()}
                                                                    </div>
                                                                ))}
                                                            </div>
                                                        </div>
                    ...
                    >
                        ...
                        >
                            <div className="p-10">
                                ...
                                <div className="grid grid-cols-2 gap-4 mb-10">
                                    {[
                                        ...
                                        <div key={idx} className="bg-slate-50/50 p-5 rounded-3xl border border-slate-100 flex items-center gap-4">
                                            <div className={`w-10 h-10 rounded-full flex items-center justify-center shadow-sm ${item.status === 'OK' ? 'bg-emerald-500 text-white' : 'bg-slate-200 text-slate-400'}`}>
                                            ...
                                            <div>
                                                ...
                                                <p className={`text-xs font-bold ${item.status === 'OK' ? 'text-emerald-600' : 'text-red-500'}`}>
                                ...
                                <div className={`p-8 rounded-[2rem] border-2 flex items-center justify-between group cursor-pointer transition-all ${getEffectiveStatus(selectedCollab) === 'LIBERADO' ? 'bg-emerald-50 border-emerald-100 hover:bg-emerald-100' : 'bg-red-50 border-red-100 hover:bg-red-100'}`}>
                                    <div>
                ...
                {showPreview && (
                    ...
                    >
                        <motion.div
                            ...
                            onClick={e => e.stopPropagation()}
                        >
                            <div className="p-8 border-b border-saas-border flex justify-between items-center bg-slate-50/50">
                                <div>
                                    ...
                                    <p className="text-sm text-text-muted font-medium mt-1">Confira os dados antes de gerar o arquivo final.</p>
                                </div>
                                <div className="flex items-center gap-3">
                                    <div className="flex bg-white rounded-xl shadow-sm border border-saas-border p-1">
                                        <button
                                    ...
                                    <button onClick={() => setShowPreview(false)} className="p-2 bg-slate-100 hover:bg-slate-200 rounded-xl transition-all">
                                        <X size={20} />
                                    </button>
                                </div>
                            </div>
                                            ...
                                            <tr key={c.chapa} className="group hover:bg-slate-50 transition-all">
                                                ...
                                                {['rh', 'saude', 'seguranca', 'grd'].map(step => (
                                                    <td key={step} className="py-4 px-4 text-center">
                                                        <div className={`w-5 h-5 mx-auto rounded flex items-center justify-center ${c[step as keyof typeof c] === 'OK' ? 'text-emerald-500' : 'text-slate-200'}`}>

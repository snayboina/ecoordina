...
3.  **Modal de Planilha (Spreadsheet View):** Visualização tabular premium com cabeçalho de seção e de colunas em tema escuro (`slate-900`). Agora inclui exportação totalmente funcional para **EXCEL** e **PDF**.

...
const getEffectiveStatus = (c: Collaborator) => {
    // Agora o status já vem calculado corretamente da API (isFullyLiberated)
    return c.status;
};
                    ...
                    <div className="flex items-center gap-6">
                        <div className="flex items-center gap-4 pl-6 border-l border-slate-200 h-8">
                            <div className="flex items-center gap-3 bg-white border border-slate-200 rounded-full py-1.5 px-2 pr-5 shadow-sm hover:shadow-md transition-all cursor-pointer group">
                                ...
                                <div className="flex flex-col">
                                    <span className="text-sm font-black text-slate-900 leading-none mb-0.5">{currentUser?.name || 'Admin Ecoordina'}</span>
                                    <span className="text-[10px] font-extrabold text-slate-600 uppercase tracking-wide">{currentUser?.role || 'USUÁRIO'}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            {activeTab === 'overview' && (
                                ...
                                >
                                    <div className="flex justify-between items-end mb-6">
                                        <div>
                                            <div className="flex items-baseline gap-4 mb-2">
                                                ...
                                                <span className="text-sm font-black text-slate-600 uppercase tracking-widest bg-slate-100/80 px-4 py-1.5 rounded-full border border-slate-200">
                                                    Janeiro 2026 até hoje
                                                </span>
                                            </div>
                                            <div className="flex items-center gap-3">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                        <div className="saas-card bg-white border-slate-200 text-slate-900 shadow-xl transform transition-all hover:-translate-y-1">
                                            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-900 mb-4">Total</p>
                                        ...
                                        <div className="saas-card bg-white border-slate-200 text-slate-900 shadow-xl transform transition-all hover:-translate-y-1">
                                            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-950 mb-4">Liberados</p>
                                            <div className="flex items-end justify-between">
                                        ...
                                        <div className="saas-card bg-white border-slate-200 shadow-xl transform transition-all hover:-translate-y-1">
                                            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-950 mb-4">Pendentes</p>
                                            <div className="flex items-end justify-between">
                                        ...
                                        <div className="saas-card bg-white border-slate-200 shadow-xl transform transition-all hover:-translate-y-1">
                                            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-950 mb-4">Eficiência</p>
                                            <div className="flex items-end justify-between">
                                ...
                                >
                                    <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
                                        <div>
                                            ...
                                            <div className="mt-1">
                                                <p className="text-text-muted font-medium">Dados de: Janeiro 2026 até hoje</p>
                                            </div>
                                        </div>

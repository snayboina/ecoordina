                                ...
                                <div className="grid grid-cols-2 gap-4 mb-10">
                                    {[
                                        ...
                                        <div key={idx} className="bg-slate-50/50 p-5 rounded-3xl border border-slate-100 flex items-center gap-4">
                                            <div className={`w-10 h-10 rounded-full flex items-center justify-center shadow-sm ${item.status === 'OK' ? 'text-white' : 'bg-slate-200 text-slate-400'}`} style={item.status === 'OK' ? { backgroundColor: '#47536f' } : {}}>
                                            ...
                                            <div>
                                                ...
                                                <p className={`text-xs font-bold ${item.status === 'OK' ? 'text-slate-700' : 'text-rose-600'}`}>

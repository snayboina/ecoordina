    ...
    const filteredCollabs = useMemo(() => {
        return collaborators
            ...
            .sort((a, b) => {
                ...
                return getTime(b.admissionDate) - getTime(a.admissionDate);
            });
            ...
            <main className="flex-1 flex flex-col relative overflow-hidden">
                ...
                <header className="h-20 bg-white/50 backdrop-blur-md border-b border-saas-border flex items-center justify-between px-10 shrink-0">
                    ...
                    <div className="flex items-center gap-6">
                            ...
                            <div className="flex items-center gap-4 bg-slate-50 px-4 py-2 rounded-xl border border-slate-100 shadow-inner">
                                <div className="flex flex-col items-end">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <span className="text-[10px] font-black text-slate-400">{dayjs(lastUpdate).format('DD/MM/YYYY')}</span>
                                        <span className="text-sm font-black text-slate-700 leading-none">{dayjs(lastUpdate).format('HH:mm:ss')}</span>
                                    </div>
                                </div>
                        ...
                        <button className="relative w-12 h-12 rounded-full border border-slate-200 flex items-center justify-center text-slate-500 hover:text-slate-700 hover:bg-slate-50 transition-all">
                            <Bell size={20} />

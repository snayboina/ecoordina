    ...
    <div className="flex-1 flex flex-col items-center text-center px-6 md:px-10 max-w-4xl mx-auto w-full">
      ...
      <div className="w-full flex flex-col items-center mb-8">
        <motion.div
          ...
          className="space-y-4"
        >
          <h1 className="text-4xl md:text-5xl font-black text-app-text tracking-tight font-display leading-[1.1]">
            Sua jornada <br />
            operacional <br />
      ...
      >
        ...
        >
          <img
            ...
            className="w-full h-full object-cover rounded-[40px] border-4 border-white shadow-floating"
            alt="Welcome"
          />
        </motion.div>
      </motion.button>
                      ...
                      return (
                        <div className="space-y-4">
                          ...
                          <motion.div
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                            className="relative overflow-hidden rounded-[32px] bg-gradient-to-br from-emerald-500 to-emerald-600 p-6 text-white shadow-premium"
                          >
            ...
            <div className={`p-8 rounded-[40px] border-2 ${isReleased(result.data_liberacao_ecoordin) ? 'bg-white border-success/20' : 'bg-white border-danger/20'} shadow-floating relative overflow-hidden`}>
              <div className="relative z-10 flex flex-col gap-8">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <StatusItem label="GERÊNCIA" value={result.grd} />
